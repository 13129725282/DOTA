...
#  size_h 切割图像高
#  step 切割步长
def image_split(img_floder, out_img_floder, size_w = 1024, size_h = 1024, step = 800):
...
#  size_w 切割图像宽
#  size_h 切割图像高
def txt_split(out_img_floder, txt_floder, out_txt_floder, size_h = 1024, size_w = 1024):
...
#  图像数据集文件夹
img_floder = r'D:\DOTA\train\images'
#  切割得到的图像数据集存放文件夹
out_img_floder = r'D:\DOTA\train\new_images'
#  txt数据集文件夹
txt_floder = r'D:\DOTA\val\labelTxt'
#  切割后数据集的标签文件存放文件夹 
out_txt_floder = r'D:\DOTA\val\new_labelTxt'
#  切割图像宽
size_w = 1024
#  切割图像高
size_h = 1024
